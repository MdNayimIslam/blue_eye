...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new flutter.tflite_audio.TfliteAudioPlugin());
    } catch(Exception e) {
      Log.e(TAG, "Error registering plugin tflite_audio, flutter.tflite_audio.TfliteAudioPlugin", e);
    }
  }
}
